...
export const ENTITY_ROLLUP_CONFIG = {
  'ent-ljc': {
    ...
    mappings: [
      ...
      { pattern: /due from.*ljc qof|investment in ljc qof/i, accountNumber: '1903' },
      { pattern: /due from.*4j|accrued interest receivable-ljc|due \(to\) from:4j/i, accountNumber: '1904' },
      ...
      { pattern: /notes payable|wloc|gloc|notes payable cre|ljc aviation|4j&l partners|notes payable - jerry|profit sharing|deferred origination|deposits:/i, accountNumber: '2999' },
  ...
  'ent-justin': {
    ...
    mappings: [
      ...
      { pattern: /notes payable:ljc financial|notes payable:l/i, accountNumber: '2900' },
