      ...
      <div className="qbd-modal qbd-backup-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="qbd-backup-meta">
          ...
          {ingest?.gmailOAuthConfigured === false && (
            <div style={{ color: '#664400' }}>
              <span className="lbl">Gmail API</span> optional — app-password IMAP is connected
            </div>
          )}
        </div>
        ...
        <div className="qbd-modal-body" style={{ padding: '8px 12px' }}>
          ...
          {(ingest?.recentImports || []).length > 0 && (
            <>
              <div className="fhd" style={{ fontSize: 11, margin: '12px 0 6px' }}>Recent statement imports</div>
