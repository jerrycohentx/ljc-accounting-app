...
import homebaseSyncRoutes from './routes/homebase-sync.js';
...
import paymentReturnRoutes from './routes/payment-returns.js';
...
app.use('/api/payment-returns', paymentReturnRoutes);
...
app.use('/api/entities/:entityId/homebase-sync', homebaseSyncRoutes);
