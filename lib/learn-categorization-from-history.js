...
export const HISTORY_MERCHANT_SEEDS = [
  ...
  { pattern: 'CVS PHARMACY', offset: '5412', label: 'Prescriptions', priority: 9 },
  { pattern: 'CENTERWELL PHARMACY', offset: '5412', label: 'Prescriptions', priority: 9 },
  { pattern: 'OPTUM HOME DELIVERY', offset: '5412', label: 'Prescriptions', priority: 9 },
  ...
  { pattern: 'ALICIA M', offset: '5613', label: 'Legal Fees — Alicia M.', priority: 8 },
  { pattern: 'KEEVER & WIESENTHAL', offset: '5611', label: 'Legal Fees — Keever & Wiesenthal', priority: 8 },
  { pattern: 'KEEVER', offset: '5611', label: 'Legal Fees — Keever & Wiesenthal', priority: 12 },
  { pattern: 'HUFFSTETLER', offset: '5612', label: 'Legal Fees — Huffstetler & Company', priority: 8 },
  { pattern: 'CAPITAL TITLE', offset: '5621', label: 'Title & Closing — Capital Title', priority: 8 },
  { pattern: 'CAPITAL TITL', offset: '5621', label: 'Title & Closing — Capital Title', priority: 9 },
  ...
  { pattern: 'VERIZONWRLSS', offset: '5760', label: 'Telephone — Verizon', priority: 10 },
  { pattern: 'VERIZON', offset: '5760', label: 'Telephone — Verizon', priority: 11 },
  ...
  // Rental utility type parents under 6100 (Wentworth Reliant/Just Energy stay on 6252 above)
  { pattern: 'RHYTHM OPS', offset: '5500', label: 'Utilities — Rhythm', priority: 10 },
  { pattern: 'CHARIOT', offset: '6150', label: 'Electric', priority: 10 },
  { pattern: 'DALLAS WATER', offset: '6140', label: 'Water', priority: 10 },
  { pattern: 'CITY OF MISSOURI', offset: '6140', label: 'Water', priority: 10 },
  { pattern: 'CITY SUGAR LAND', offset: '6140', label: 'Water', priority: 10 },
  { pattern: 'ATMOS ENERGY', offset: '6160', label: 'Gas', priority: 10 },
  { pattern: 'ATMOS', offset: '6160', label: 'Gas', priority: 11 },
  ...
  { pattern: 'WALGREENS', offset: '5412', label: 'Prescriptions', priority: 11 },
  ...
  { pattern: 'MICROSOFT', offset: '5700', label: 'Office & Software', priority: 20 },
  { pattern: 'PAYPAL *MICROSOFT', offset: '5700', label: 'Office & Software', priority: 8 },
  ...
  { pattern: 'ANTHROPIC', offset: '5700', label: 'Office & Software — Anthropic', priority: 9 },
  { pattern: 'CURSOR', offset: '5700', label: 'Office & Software — Cursor', priority: 20 },
  ...
  { pattern: 'INTUIT QUICKBOOKS', offset: '5700', label: 'Office & Software — QuickBooks', priority: 9 },
  { pattern: 'QUICKBOOKS', offset: '5700', label: 'Office & Software — QuickBooks', priority: 10 },
  { pattern: 'BLUEHOST', offset: '5780', label: 'Advertising — Bluehost', priority: 10 },
  { pattern: 'CALLRAIL', offset: '5780', label: 'Advertising — CallRail', priority: 10 },
  { pattern: 'STOR-IT SELF STORAGE', offset: '5740', label: 'Office supplies — storage', priority: 10 },
  { pattern: 'FIRST AMERICAN FLOOD', offset: '5300', label: 'Flood insurance / data', priority: 9 },
  { pattern: 'HIGHLAND SPECIALITY PHARM', offset: '5412', label: 'Prescriptions', priority: 9 },
  { pattern: 'HIGHLAND SPECIALTY PHARM', offset: '5412', label: 'Prescriptions', priority: 9 },
  { pattern: 'WELLBEL', offset: '5412', label: 'Prescriptions', priority: 10 },
  { pattern: 'SLADE & BAKER', offset: '5410', label: 'Member vision', priority: 9 },
  // Methodist Scurlock parking intentionally not auto-categorized (manual)
  ...
  { pattern: 'ONLINENOTAR', offset: '5601', label: 'Notary', priority: 9 },
  { pattern: 'PAYPAL *ONLINENOTAR', offset: '5601', label: 'Notary', priority: 8 },
