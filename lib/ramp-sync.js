 ...
 *
 * Booking model: Ramp charges DR expense / CR "Ramp Card" liability (2013).
 * The Ramp statement payment that leaves Simmons should later be booked
 * DR 2013 / CR Simmons so the card liability nets to zero — see the note in
 * integration/RAMP.md. Never use 2015 (Profit Sharing Payable).
 */
import fs from 'fs';
...
const RAMP_CARD_ACCOUNT_NUMBER = process.env.RAMP_CARD_ACCOUNT_NUMBER || '2013';
const RAMP_CARD_ACCOUNT_NAME = 'Credit Card - Ramp Visa';
