...
export async function buildWorksheet(db, { entityId, accountId, statementDate }) {
  ...
  return {
    ...
    statementDate,
    beginningBalance,
    endingBalance: session?.ending_balance != null ? round2(session.ending_balance) : null,
    sessionStatus: periodSession?.status || displayStatus,
    sessionDifference,
    periodSession,
    priorClosedSession,
    priorSession: periodSession,
    statementPeriod: statementView.period,
