...
export async function categorizeAmexTransaction(db, entityId, txn) {
  // Payments/credits on the Amex statement must NOT post CR Cash.
  // Simmons/OFX already records DR 2010 / CR 1000 when the ACH clears.
  // Posting cash again from the Amex feed double-counts the outflow and
  // broke the Jan 2026 balance sheet (Simmons went negative).
  ...
  // (which often dump everything to 5700 Office & Software).
