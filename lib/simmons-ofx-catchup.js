...
/**
 * Hard-blocked: never force Simmons books to OFX ledger via 3900 Opening Balance Equity.
 * Resolve missing/mismatched bank transactions instead.
 */
async function ensureOfxLedgerTrueUp(db, targetBalance, _userId) {
  ...
  return {
    ...
    reason:
      'Hard rule: Simmons OFX equity true-up (plug to 3900) is permanently disabled. Import/fix real transactions until books match the statement.',
